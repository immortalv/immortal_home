...
const profileDataMock = {
  ...
  otherPhotos: [getProfileImg("avatar-image-1", "jpg"), getProfileImg("avatar-image-1", "jpg"), getProfileImg("avatar-image-1", "jpg"), getProfileImg("avatar-image-1", "jpg"), getProfileImg("avatar-image-1", "jpg"),],
